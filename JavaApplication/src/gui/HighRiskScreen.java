...
public class HighRiskScreen extends JFrame 
{
    ...
    public HighRiskScreen(MainFrame dashboard, Customer[] customerArray, CustomerDAO dao) 
    {
        this.dashboard = dashboard;
        this.customerArray = customerArray;
        this.dao = dao;

        setTitle("ChurnInsight - High-Risk Customers");
        setSize(1100, 650);
    ...
    private void buildUI() 
    {
        ...
        JPanel headerPanel = new JPanel() 
        {
            ...
            protected void paintComponent(Graphics g) 
            {
                ...
                GradientPaint gp = new GradientPaint(0, 0, new Color(100, 20, 20), getWidth(), 0, new Color(200, 50, 50));
                g2d.setPaint(gp);
        ...
        JLabel titleLabel = new JLabel("⚡ High-Risk Customers");
        ...
        JPanel tableContainer = new JPanel(new BorderLayout())
        {
            ...
            protected void paintComponent(Graphics g) 
            {
                ...
                Graphics2D g2d = (Graphics2D) g.create();
                g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                GradientPaint gp = new GradientPaint(0, 0, new Color(255, 245, 245), 0, getHeight(), new Color(255, 230, 230));
                g2d.setPaint(gp);
                g2d.fillRect(0, 0, getWidth(), getHeight());
                g2d.dispose();
            }
        ...
        bottomPanel.setBorder(BorderFactory.createMatteBorder(1, 0, 0, 0, new Color(220, 200, 200)));
    ...
    private void styleTable() 
    {
        table.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer()
        {
                    ...
                    boolean isSelected, boolean hasFocus, int row, int column) 
            {
                ...
                if (!isSelected) 
                {
                    c.setBackground(row % 2 == 0 ? Color.WHITE : new Color(255, 240, 240));
                }
                return c;
            }
        });
        table.getTableHeader().setBackground(new Color(100, 20, 20));
        table.getTableHeader().setForeground(Color.WHITE);
        table.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 13));
        table.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        table.setRowHeight(25);
        table.setShowGrid(true);
        table.setGridColor(new Color(220, 200, 200));
    }
}
